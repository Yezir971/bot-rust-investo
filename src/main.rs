...
async fn main() {
    ...
    // let api_secret: String  = "ldqmdsqkdsqfkdqfdd64fd5sfdsfds".to_string(); //valeur de test
    // let api_key: String = "fqkfq,fdsf,dkqsfdksqfdksqfdsfks".to_string(); // valeur de test


    // CryptoComExchange::new_user(api_secret, api_key, base_url_cryptocom);
